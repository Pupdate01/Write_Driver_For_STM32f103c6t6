...
void USART_Init(USART_Handle_t *pUSARTHandle) {
	...
	if (pUSARTHandle->USART_Config.USART_Mode == USART_MODE_ONLY_RX) {
		...
		//Implement the code to enable the Tranmitter bit field
...
void USART_IRQHandling(USART_Handle_t *pUSARTHandle) {
	...
	//Implement the code to check the state of TCEIE bit in the CR1
	...
	temp1 = pUSARTHandle->pUSARTx->SR & (1 << USART_FLAG_TXE);

	//Implement the code to check the status of TXEIE bit in CR1
			...
			if (pUSARTHandle->RxLen > 0) {
				...
				if (pUSARTHandle->USART_Config.USART_WordLength
					...
					if (pUSARTHandle->USART_Config.USART_ParityControl
						...
						//read only first 9bits so mask the DR with 0x01FF
					...
					//We are going to receive 8bit data in frame
...
//Note : CTS feature is not applicable for UART4 and UART5
	...
	//Implement the code to check the status of IDLEIE bit in CR1
	temp2 = pUSARTHandle->pUSARTx->CR1 & (1 << USART_CR1_IDLETE);
